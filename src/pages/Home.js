...
function Home() {
    ...
    return (
        <>
            ...
            <div className="card-section">
                <div className="container">
                    <h1 className="card-main-title">Our Service</h1>
                    <div className="row pt-3 card-cl-body">
                        {cardImage.map((data, index) => (
                            <div className="col-lg-4 col-md-6" key={index}>
                                <div className="card service-card-wrap">
                                    <img src={data.image} className="card-img-top card-img-wrap" alt="..." />
                                    <div className="card-body card-body-wrap">
                                        <h5 className="card-title">{data.title}</h5>
                                        <p className="card-text">{data.text}</p>
            ...
            <div className="card-section">
                    ...
                    <div className="row">
                        {gallery.map((data, index) => (
                            <div className="col-lg-4 col-md-6 col-sm-12" key={index}>
                                <div className="gallery-img-wrap">
                                    <img src={data.image} className="gallery-img" alt={`Gallery image ${data.sn}`} />
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className='card-main-title'>
                    ...
                    <div>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3684.9182227939027!2d88.36305917481057!3d22.544735933991994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a0276e173067333%3A0x873c34f5d28e9d0!2s1%2C%20Jannagar%20Rd%2C%20Park%20Circus%2C%20Beniapukur%2C%20Kolkata%2C%20West%20Bengal%20700017!5e0!3m2!1sen!2sin!4v1724617644453!5m2!1sen!2sin" width="600" height="450" allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </>
